...
(function ($) {
  ...
  if (!window.pathway_admin) {
    return;
  }

  var _window$pathway_admin = window.pathway_admin,
      builderStatusData = _window$pathway_admin.builderStatusData,
      getStartedData = _window$pathway_admin.getStartedData;
