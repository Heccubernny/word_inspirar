...
wp_localize_script(
	...
	array(
		...
		'builderStatusData' => array(
			'status'       => pathway_theme()->getPluginsManager()->getPluginState( pathway_get_builder_plugin_slug() ),
			'install_url'  => pathway_theme()->getPluginsManager()->getInstallLink( pathway_get_builder_plugin_slug() ),
			'activate_url' => pathway_theme()->getPluginsManager()->getActivationLink( pathway_get_builder_plugin_slug() ),
			'slug'         => pathway_get_builder_plugin_slug(),
			'messages'     => array(
		...
		<div class="content-holder">
			<div class="front-page-preview">
				...
				<div class="kubio-front-page-preview-image-scroller">
					<img src="<?php echo esc_url( pathway_theme()->getFrontPagePreview() ); ?>"/>
				</div>
			</div>

			<div class="messages-area">
				<div class="title-holder">
					<h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', pathway_theme()->getName() ); ?></h1>
				</div>
				<div class="action-buttons">
					<button class="button button-primary button-hero start-with-predefined-design-button">
						<?php Translations::escHtmlE( 'install_homepage', pathway_theme()->getName() ); ?>
					</button>
				</div>
